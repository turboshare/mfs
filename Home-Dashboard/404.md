...
function getVariableData() {
    ...
    myContractInstance.methods.users(account).call().then(function (result1) {
            ...
            $('.currentuseridlink').html("https://maticforce.space/signup/?referralid=" + result1.id);




            $('.currentuseridlink').val("https://maticforce.space/signup/?referralid=" + result1.id);
            ...
            $('.sharebutton').attr('data-url', "https://maticforce.space/signup/?referralid=" + result1.id);
