  ...
  <head>
    ...
    <script>
        ...
        if (account == null) {
           ...
           location.href = "https://maticforce.space/login";
        }
    </script>

    <link rel="shortcut icon" type="image/x-icon" href="https://maticforce.space/Matic-Force-Space.png">
...
function getVariableData() {
    ...
    myContractInstance.methods.users(account).call().then(function (result1) {
            ...
            $('.currentuseridlink').html("https://maticforce.space/register?referralid=" + result1.id);




            $('.currentuseridlink').val("https://maticforce.space/register?referralid=" + result1.id);




            $('.sharebutton').attr('data-url', "https://maticforce.space/register?referralid=" + result1.id);
...
function getReferralCommission() {
    ...
    var level1 = parseFloat(5); var level2 = parseFloat(1); var level3 = parseFloat(1); var level4 = parseFloat(1);
    ...
    var events = myContractInstance.getPastEvents('getMoneyForLevelEvent', { filter: { _user: account }, 'fromBlock': 0, 'toBlock': 'latest'}, function (error, log) {
        ...
        if (!error) {
            $.each(log, function (key, value) {
                ...
                if (level == 1) {
                    referraltotal = parseFloat(referraltotal) + parseFloat("5");

                }
                else if (level == 2) {

                    referraltotal = parseFloat(referraltotal) + parseFloat("1");
                }
                else if (level == 3) {
                    referraltotal = parseFloat(referraltotal) + parseFloat("1");
                    ...
                    referraltotal = parseFloat(referraltotal) + parseFloat("0.20");
...
$(document).ready(function () {
    $('.pool1pay').click(function (demo) {
        ...
        try {
            ...
            ethereum.enable();
            myContractInstance1.methods.buyPool1().send({ from: account, value: 100000000000000000, gas: 300000 })
                .on('transactionHash', function (hash) {
                    console.log('------->',hash)
                    $('.pool1pay').hide();
                    $('.pool1transaction').show();
                    $('.pool1transaction').html('<a href="https://polygonscan.com/tx/' + hash + '">Track</a>');
    ...
    $('.pool2pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool2().send({ from: account, value: 200000000000000000, gas: 300000 })
                .on('transactionHash', function (hash) {

                    $('.pool2pay').hide();
                    $('.pool2transaction').show();
                    $('.pool2transaction').html('<a href="https://polygonscan.com/tx/' + hash + '">Track</a>');
    ...
    $('.pool3pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool3().send({ from: account, value: 500000000000000000, gas: 300000 })
                .on('transactionHash', function (hash) {

                    $('.pool3pay').hide();
                    $('.pool3transaction').show();
                    $('.pool3transaction').html('<a href="https://polygonscan.com/tx/' + hash + '">Track</a>');
    ...
    $('.pool4pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool4().send({ from: account, value: 1000000000000000000, gas: 300000 })
                .on('transactionHash', function (hash) {

                    $('.pool4pay').hide();
                    $('.pool4transaction').show();
                    $('.pool4transaction').html('<a href="https://polygonscan.com/tx/' + hash + '">Track</a>');
    ...
    $('.pool5pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool5().send({ from: account, value: 2000000000000000000, gas: 300000 })
                .on('transactionHash', function (hash) {

                    $('.pool5pay').hide();
                    $('.pool5transaction').show();
                    $('.pool5transaction').html('<a href="https://polygonscan.com/tx/' + hash + '">Track</a>');
    ...
    $('.pool6pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool6().send({ from: account, value: 5000000000000000000, gas: 300000 })
                .on('transactionHash', function (hash) {

                    $('.pool6pay').hide();
                    $('.pool6transaction').show();
                    $('.pool6transaction').html('<a href="https://polygonscan.com/tx/' + hash + '">Track</a>');
    ...
    $('.pool7pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool7().send({ from: account, value: 10000000000000000000, gas: 300000 })
                .on('transactionHash', function (hash) {

                    $('.pool7pay').hide();
                    $('.pool7transaction').show();
                    $('.pool7transaction').html('<a href="https://polygonscan.com/tx/' + hash + '">Track</a>');
    ...
    $('.pool8pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool8().send({ from: account, value: 20000000000000000000, gas: 300000 })
                .on('transactionHash', function (hash) {

                    $('.pool8pay').hide();
                    $('.pool8transaction').show();
                    $('.pool8transaction').html('<a href="https://polygonscan.com/tx/' + hash + '">Track</a>');
    ...
    $('.pool9pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool9().send({ from: account, value: 50000000000000000000, gas: 300000 })
                .on('transactionHash', function (hash) {

                    $('.pool9pay').hide();
                    $('.pool9transaction').show();
                    $('.pool9transaction').html('<a href="https://polygonscan.com/tx/' + hash + '">Track</a>');
    ...
    $('.pool10pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool10().send({ from: account, value: 100000000000000000000, gas: 300000 })
                .on('transactionHash', function (hash) {

                    $('.pool10pay').hide();
                    $('.pool10transaction').show();
                    $('.pool10transaction').html('<a href="https://polygonscan.com/tx/' + hash + '">Track</a>');
...
<script async defer id="github-bjs" src="https://buttons.github.io/buttons.js"></script>
  ...
  <script src="https://maticforce.space/Home-Dashboard/assets/js/socialjs.js"></script>
            ...
            <div class="col-xl-12">
                <div class="banner banner-color mt-0">
                    <div class="col-xl-2 col-lg-3 col-md-12">
                        <img src="https://maticforce.space/Home-Dashboard/Content/assets/images/svg/new_message.svg" alt="image" class="image">
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 text-right d-flex d-block">
                        <div class="socialjs">
                            ...
                            <a class="sharebutton facebook btn " style="background-color:#3b5998;color:white" data-basecount="" data-sharetype="facebook" data-text="The page title" title="Share this on Facebook" href="#" data-url="https://maticforce.space/signup/?referralid=1"><i class=" fa fa-facebook"></i></a>
                            ...
                            <li>
                                <div>
                                    <div class="row">
                                        <div class="d-flex">
                                            <div class="">
                                                <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/user.png" class="w-7 h-7" alt="">
                                            </div>
                                            <div class="ml-3">
                            ...
                            <li>
                                <div>
                                    <div class="row">
                                        <div class="d-flex">
                                            <div class="">
                                                <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/1.png" class="w-7 h-7" alt="">
                                            </div>
                                            <div class="ml-3">
                            ...
                            <li>
                                <div>
                                    <div class="row">
                                        <div class="d-flex">
                                            <div class="">
                                                <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/2.png" class="w-7 h-7" alt="">
                                            </div>
                                            <div class="ml-3">
                            ...
                            <li>
                                <div>
                                    <div class="row">
                                        <div class="d-flex">
                                            <div class="">
                                                <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/3.png" class="w-7 h-7" alt="">
                                            </div>
                                            <div class="ml-3">
                            ...
                            <li>
                                <div>
                                    <div class="row">
                                        <div class=" d-flex">
                                            <div class="">
                                                <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/4.png" class="w-7 h-7" alt="">
                                            </div>
                                            <div class="ml-3">
                            ...
                            <li>
                                <div>
                                    <div class="row">
                                        <div class=" d-flex">
                                            <div class="">
                                                <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/5.png" class="w-7 h-7" alt="">
                                            </div>
                                            <div class="ml-3">
                            ...
                            <li>
                                <div>
                                    <div class="row">
                                        <div class=" d-flex">
                                            <div class="">
                                                <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/6.png" class="w-7 h-7" alt="">
                                            </div>
                                            <div class="ml-3">
                            ...
                            <li>
                                <div>
                                    <div class="row">
                                        <div class=" d-flex">
                                            <div class="">
                                                <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/7.png" class="w-7 h-7" alt="">
                                            </div>
                                            <div class="ml-3">
                            ...
                            <li>
                                <div>
                                    <div class="row">
                                        <div class=" d-flex">
                                            <div class="">
                                                <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/8.png" class="w-7 h-7" alt="">
                                            </div>
                                            <div class="ml-3">
                            ...
                            <li>
                                <div>
                                    <div class="row">
                                        <div class=" d-flex">
                                            <div class="">
                                                <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/9.png" class="w-7 h-7" alt="">
                                            </div>
                                            <div class="ml-3">
                            ...
                            <li>
                                <div>
                                    <div class="row">
                                        <div class=" d-flex">
                                            <div class="">
                                                <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/10.png" class="w-7 h-7" alt="">
                                            </div>
                                            <div class="ml-3">
                        ...
                        <div class="d-flex">
                            ...
                            <div class=" my-auto ml-auto">
                                <div class="chart-wrapper text-center">
                                    <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/d1.png" class="h-7" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card overflow-hidden bg-gradient-secondary">
                    <div class="card-body text-white">
                        ...
                        <div class="d-flex">
                            ...
                            <div class=" my-auto ml-auto">
                                <div class="chart-wrapper text-center">
                                    <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/d2.png" class="h-7" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card overflow-hidden bg-teal">
                    <div class="card-body text-white">
                        <div class="d-flex">
                            ...
                            <div class=" my-auto ml-auto">
                                <div class="chart-wrapper text-center">
                                    <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/d4.png" class="h-7" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card overflow-hidden" style="background-color:#004172;color:#fff;">
                    ...
                    <div class="card-body text-white">
                        <div class="d-flex">
                            ...
                            <div class=" my-auto ml-auto">
                                <div class="chart-wrapper text-center">
                                    <img src="https://maticforce.space/Home-Dashboard/Content/assets/img/d5.png" class="h-7" alt="">
                                </div>
                            </div>
...
<style>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6  mt-2 mb-2 text-center">
                        Copyright © 2023 <a href="#" class="fs-14 text-primary">https://maticforce.space</a>
                    </div>
                </div>
            </div>
        </footer>
   ...
   <!-- Sparkline JS-->
   <script src="https://maticforce.space/signup/jquery.sparkline.min.js"></script>

   <!-- Bootstrap-daterangepicker js -->
   <script src="https://maticforce.space/signup/daterangepicker.js"></script>

   <!-- Bootstrap-datepicker js -->
   <script src="https://maticforce.space/signup/bootstrap-datepicker.js"></script>

   <!-- Chart-circle js -->
   <script src="https://maticforce.space/signup/circle-progress.min.js"></script>
   ...
   <!--Newsticker js-->
   <script src="https://maticforce.space/signup/jquery.jConveyorTicker.js"></script>
   <script src="https://maticforce.space/Home-Dashboard/Content/assets/js/newsticker.js"></script>

   <!-- Chart js-->
   <script src="https://maticforce.space/Home-Dashboard/assets/plugins/chart/chart.min.js"></script>
                
   <!-- Nice-select js-->
   <script src="https://maticforce.space/signup/jquery.nice-select.js"></script>
   <script src="https://maticforce.space/signup/nice-select.js"></script>

   <!-- Apexchart js-->
   <script src="https://maticforce.space/Home-Dashboard/Content/assets/js/apexcharts.js"></script>

   <!-- Rightsidebar js -->
   <script src="https://maticforce.space/signup/sidebar.js"></script>

   <!-- Index js-->
   <script src="https://maticforce.space/signup/index2.js"></script>

   <!-- Custom js-->
   <script src="https://maticforce.space/signup/custom.js"></script>
   <!--LOgout Js-->
