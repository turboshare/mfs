...
<html lang="en">
<head>
    <title>Matic Force Signup</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" type="image/x-icon" href="https://maticforce.space/Matic-Force-Logo.png">
...
.login100-form {
    ...
    <script>
       ...
       document.getElementById("referralid").value = (referralid) ? referralid : "" ;
     }, 100);
...
$(document).ready(function () { 
        ...
        try {
            myContractInstance.methods.users(account).call().then(function (result) {
                if (result[0]) {
                    ...
                    location.href = "https://maticforce.github.io/mfs/Home-Dashboard";
                }
                else {
  ...
  MyContract = new web3.eth.Contract(abi, address);
    ...
    function SignUpPay(account) {
        var add = $('[name="referral"]').val();
        myContractInstance.methods.regUser(add).send({ from: account, value: 10000000000000000000, gasprice: 200  })
            ...
            <div class="wrap-login100">
                <div class="login100-form">
                    ...
                    <form class="w-100 validate-form" onsubmit="return false" id="signupform">
                        ...
                        <div class="w-100">
                            <img src="https://mfs.maticforce.space/wallet.png" class="w-100 p-b-34" />
                        </div>
                        ...
                        <div class="wrap-input100 validate-input m-b-20" data-validate="Type user name">
                            <input id="referralid" class="input100" type="text"  name="referral" value=""  placeholder="Referral code">
                        ...
                        <p class="m-b-15 text-right text-white">Allready have account ? <a href="https://maticforce.github.io/mfs/signin" class="text-white"> Sign in</a></p>
