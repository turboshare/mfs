...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://maticforce.space/Content/Front-theme/theme-assets/images/ico/favicon.ico">
...
function getVariableData() {
    ...
    myContractInstance.methods.users(account).call().then(function (result1) {
            ...
            $('.currentuseridlink').html("https://maticforce.space/User/signup?referralid=" + result1.id);

            $('.currentuseridlinknew').html("https://link.trustwallet.com/open_url?coin_id=60&url=https://maticforce.space/User/signup?referralid=" + result1.id);



            $('.currentuseridlink').val("https://maticforce.space/User/signup?referralid=" + result1.id);

            $('.currentuseridlinknew').val("https://link.trustwallet.com/open_url?coin_id=60&url=https://maticforce.space/User/signup?referralid=" + result1.id);



            $('.sharebutton').attr('data-url', "https://maticforce.space/User/signup?referralid=" + result1.id);
...
window.addEventListener('load', function () {
    if (typeof web3 !== 'undefined' && account == null) {
                                ...
                                <div class=" tab-menu-heading">
                                    <div class="tabs-menu1 ">
                                        ...
                                        <ul class="nav panel-tabs">
                                            <li class=""><a href="#tab5" class="active" data-toggle="tab">Referral</a></li>
                                            <li><a href="#tab6" data-toggle="tab">Pool Payments</a></li>
                                            ...
                                            <div class="">
                                                <div class="table-responsive">
                                                    <table class="table card-table table-striped text-nowrap table-bordered">
                                                        ...
                                                        <tbody class="autopool_table"></tbody>
                                                    </table>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="">
                                                <div class="table-responsive">
                                                    <table class="table card-table table-striped text-nowrap table-bordered">
                                                        ...
                                                        <tbody class="transaction_autopool"></tbody>
                                                    </table>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $(".resp-tabs-list li.trans").addClass('resp-tab-active active')
