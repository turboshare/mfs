...
<html lang="en">
  <head>
    ...
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="https://maticforce.space/signin/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="https://maticforce.space/signin/style.min.css">
    <link rel="stylesheet" type="text/css" href="https://maticforce.space/signin/animate.min.css">
    <link rel="stylesheet" type="text/css" href="https://maticforce.space/signin/flipclock.css">
    <link rel="stylesheet" type="text/css" href="https://maticforce.space/signin/swiper.min.css">
    <!-- END VENDOR CSS-->
    <!-- END CRYPTO CSS-->
    <!-- BEGIN Page Level CSS-->
    <link rel="stylesheet" type="text/css" href="https://maticforce.space/signin/template-counter.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="https://maticforce.space/signin/style.css">
    <!-- END Custom CSS-->


    <link rel="stylesheet" type="text/css" href="https://maticforce.space/signin/font-awesome.min.css">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="https://maticforce.space/signin/icon.font.min.css">

    <link rel="stylesheet" type="text/css" href="https://maticforce.space/signin/util.css">
    <link rel="stylesheet" type="text/css" href="https://maticforce.space/signin/main.css">
...
function SigninPage(){
    ...
    //                    message: "Welcome to Matic Force"
    //                }, {
    //                        type: 'minimalist',
    //                        placement: {
    //                            from: "bottom",
    ...
    //                var time = "2 minutes ago";
    //                $.notify({
    //                    icon: 'https://maticforce.space/Matic-Force-Logo.png',
...
$(document).ready(function () { 
  ...
  MyContract = new web3.eth.Contract(abi, address);
    ...
    function SignUpPay(account) {
        var add = $('[name="referral"]').val();
        myContractInstance.methods.regUser(add).send({ from: account, value: 10000000000000000000, gasprice: 2000 })
    ...
    <script src="https://maticforce.space/signin/socialjs.js"></script>
    <script>
            ...
            <div class="wrap-login100">
                <div class="login100-form">
                    <form class="w-100 validate-form" onsubmit="return false" id="signinform">
                        ...
                        <div class="w-100">
                            <img src="https://maticforce.space/wallet.png" class="w-100 p-b-34" />
                        </div>
                        <div class="wrap-input100 validate-input m-b-20" data-validate="Type user name">
                            <input id="first-name" class="input100" type="text" name="ethaddress" placeholder="Enter Matic address">
                        ...
                        <div class="w-full text-center m-t-30">
                            ...
                            <a href="https://polygonscan.com/address/0x00008e70635562edD0Dd97A1B175234556a21BCb" class="txt3" target="_blank">
                    ...
                    <a href="https://maticforce.space/MaticForce.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 1</a>
                </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 text-center d-flex d-block m-t-10">
                        <div class="row">
                            ...
                            <div class="socialjs col-lg-12 m-t-10">
                                ...
                                <a class="sharebutton telegram btn" target="_blank" style="background-color:#0088cc;color:white" href="https://telegram.me/MaticForce"><i class="fa fa-telegram"></i> </a>
                ...
                <div class="login100-more ">
                    <div class="col-lg-12 m-t-30">
                        <a href="https://maticforce.space"> <img src="https://maticforce.space/Matic-Force-Logo.png" style="" class="w-100" /></a>
                    </div>
                    <div class="w-100 m-t-100 m-l-auto m-r-auto text-center download-buttons">
                        ...
                        <a href="https://tokenpocket.pro/" target="_blank" class="m-b-5 btn btn-info">Download TokenPokcket</a>
                    </div>
                </div>
            </div>
        </div>
